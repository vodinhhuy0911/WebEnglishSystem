# Generated by Django 3.2.12 on 2022-04-21 02:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('EnglishSystem', '0002_auto_20220419_1446'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='choices', to='EnglishSystem.question')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='EnglishSystem.question')),
                ('quiz_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attempts', to='EnglishSystem.quizprofile')),
                ('selected_choice', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='EnglishSystem.choice')),
            ],
            options={
                'abstract': False,
            },
